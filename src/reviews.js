...
document.addEventListener("DOMContentLoaded", (e) => {
    ...
    const images = {
        johansen: require("../assets/johansen.png"),
        eleonore: require("../assets/eleonore.png"),
        miguel: require("../assets/miguel.png"),
        stevie: require("../assets/stevie.png"),
        donnette: require("../assets/donnette.png"),
        reggie: require("../assets/reggie.png"),
        george: require("../assets/george.png"),
        ludwig: require("../assets/ludwig.png"),
        rembrandt: require("../assets/rembrandt.png"),
        melessia: require("../assets/melessia.png"),
        kareem: require("../assets/kareem.png"),
        nadine: require("../assets/nadine.png"),
        loretta: require("../assets/loretta.png"),
        nicole: require("../assets/nicole.png"),
